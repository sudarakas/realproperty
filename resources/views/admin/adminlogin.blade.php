    ...
    <div class="columns fulllogin is-centered">
        <div class="column is-two-thirds leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                ...
                <p class="subtitle  has-text-centered is-size-7 tinytextlogin">Enter your email and password to login your realproperty admin panel.</p>
            </div>
            <div class="loginform">
                <form method="POST" action="{{ route('admin.login.submit') }}">
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <input class="input {{ $errors->has('password') ? ' is-danger' : '' }} is-primary inputline is-medium" id="password" type="password"
...
<div class="columns is-mobile is-centered loginbox is-vcentered">
    <div class="column is-two-fifths loginform">
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="field">
                <p class="control has-icons-left has-icons-right">
                    <input class="input {{ $errors->has('email') ? ' is-danger' : '' }} is-primary" id="email" type="email" value="{{ old('email') }}"
            ...
            <div class="field">
                <p class="control has-icons-left">
                    <input class="input {{ $errors->has('password') ? ' is-danger' : '' }} is-primary" id="password" type="password" name="password"
