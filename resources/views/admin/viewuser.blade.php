                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="/{{checkPropertyTypeById($property->id)}}/{{getPropertyTypeIdById($property->id)}}" class="button is-danger nounnounderlinebtn" target="_blank"><i class="far fa-trash-alt"></i></a></td> 
                        </tr>
                        @endforeach @endif
                    </tbody>
                </table>
