...
<section class="hero is-info is-medium is-bold">
    ...
    <span class="container has-text-centered textbox">
            <h1 class="title is-1">Add New Article</h1>
        </span>
</section>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="field">
                                <div class="control">
                                    ...
                                    <input class="input is-primary" type="text" placeholder="Article Title" name="title">
                                </div>
                            ...
                            <div class="filed">
                                <div class="control">
                                    ...
                                    <textarea class="textarea is-primary" placeholder="Article Content" rows="20" name="content"></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="field">
                            ...
                            <div class="filed">
                                    <div class="control">
                                        <button type="submit" class="button is-primary">Add Article</button>
                                    </div>
                                </div>
                        </form>
                    </div>
