...
<body>
    ...
    <div class="columns is-mobile is-centered has-background-white">
      <div class="container has-text-centered aboutus has-text-dark">
          ...
          <br>
          <p>Welcome to Real Property, your number one source for all things real estate. We're dedicated to giving you the very best of real estate, with a focus on fast, trust, efficient. <br>
          <br>
