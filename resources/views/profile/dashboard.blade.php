<div class="column displaybox">
        <nav class="navbar has-background-link profilenavbar" role="navigation" aria-label="main navigation">
            ...
            <div class="column">
                <div class="card has-background-danger">
                    <div class="card-content cardbox">
                        ...
                        <p class="is-pulled-right">Houses</p>
                    </div>
                </div>
            </div>
            <div class="column">
